    ...
    <div class="glass-effect p-8 rounded-3xl">
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="glass-effect p-4 rounded-xl">
                    ...
                    <?php if ($imageExists && $product['image'] !== 'default.jpg'): ?>
                        ...
                        <p class="text-sm text-gray-100"><?= htmlspecialchars($product['image']) ?></p>
                    <?php else: ?>
                        ...
                        <p class="text-sm text-gray-100">Belum ada gambar</p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-100 mt-2">Kosongkan jika tidak ingin mengganti gambar</p>
            </div>
